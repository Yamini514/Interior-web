...
export function FinalCtaSection() {
  return (
    <section className="mx-auto max-w-7xl px-4 pb-20 pt-20 sm:px-6 lg:px-8">
      <Reveal className="relative overflow-hidden rounded-[34px] border border-white/12 bg-gradient-to-r from-amber-200/18 via-white/10 to-cyan-300/14 px-6 py-12 shadow-[0_30px_100px_rgba(15,23,42,0.26)] backdrop-blur-xl sm:px-10">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-amber-100/80">Let&apos;s build it</p>
            <h2
