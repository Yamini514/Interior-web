...
export function PortfolioCtaSection() {
  return (
    <section className="mx-auto max-w-7xl px-4 pb-20 pt-20 sm:px-6 lg:px-8">
      <Reveal className="relative overflow-hidden rounded-[34px] border border-white/12 bg-gradient-to-r from-cyan-300/14 via-white/10 to-amber-200/16 px-6 py-12 shadow-[0_30px_100px_rgba(15,23,42,0.26)] backdrop-blur-xl sm:px-10">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-stone-100/80">Start now</p>
            <h2
